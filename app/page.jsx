      ...
      <main>
        ...
        <div className='relative overflow-hidden  '>
          <div className='absolute z-0 '>
            <img
              className='opacity-[1] z-0 top-0 left-0 right-0 bottom-0   max-w-none'
          ...
          <div
            aria-hidden='true'
            className='absolute inset-x-0 top-0 h-48 bg-gradient-to-b from-black'
          />
          <div className='relative z-50 top-0 right-0 left-0 bottom-0 opacity-[0.4]'>
            <TeamSection />
          </div>
          ...
          <div className='relative overflow-hidden '>
            <div
              aria-hidden='true'
              className='absolute inset-x-0 top-0 h-48 bg-gradient-to-b from-black to-gray-900'
            />
          </div>
        </div>
